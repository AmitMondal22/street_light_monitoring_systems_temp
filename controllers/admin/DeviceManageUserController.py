...
def list_user_device(params):
    try:
        select="o.organization_name,o.organization_id,u.user_id,u.user_name,u.user_email,u.user_active_status,d.device_id,d.device,d.model,d.lat,d.lon,d.imei_no,d.device_type,d.meter_type, mud.manage_user_device_id"
